...
var SIZE = 200;
var MARGIN = 1.3 + Math.random() / 2;

var DotMatrixStyleSet = function (_StyleSet) {
...
var Dot = function (_UI$Element) {
    inherits(Dot, _UI$Element);
...
var DotRow = function (_UI$Element2) {
    inherits(DotRow, _UI$Element2);
    ...
    createClass(DotRow, [{
        key: "getDOMAttributes",
        value: function getDOMAttributes() {
            var attr = get$1(DotRow.prototype.__proto__ || Object.getPrototypeOf(DotRow.prototype), "getDOMAttributes", this).call(this);
...
var DotMatrix = function (_UI$Element3) {
    inherits(DotMatrix, _UI$Element3);
...
var ButtonMatrix = function (_UI$Element) {
    inherits(ButtonMatrix, _UI$Element);
...
var DemoTabArea = function (_UI$Element2) {
    inherits(DemoTabArea, _UI$Element2);
...
var start$1 = performance.now();
var dotMatrix = DotMatrix.create(document.body);

console.log("Duration: ", performance.now() - start$1);
// setInterval(() => {
//     dotMatrix.update();
// }, 10);
...
for (var i = 0; i < ITER; i++) {
    var attr = UI.T("Ceva fodfkgjh dfgd gdf g df gd fg s fgsg ");
}

console.log("Duration2: ", performance.now() - start$1);
